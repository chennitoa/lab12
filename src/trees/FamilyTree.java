...
public class FamilyTree
{
    ...
    private static class TreeNode
    {
        ...
        void addChild(TreeNode childNode)
        {
        	...
        	System.out.println("Added " + childNode.name + " to " + this.name);
        }
        ...
        TreeNode getNodeWithName(String targetName)
        {
        	...
        	//System.out.println("Checking " + this.name + " for " + targetName);
            ...
            for (TreeNode child: children)
            {
                if (child.getNodeWithName(targetName) != null) {
                	//System.out.println("Found " + this.name + " for " + targetName);
        ...
        ArrayList<TreeNode> collectAncestorsToList()
        {
            ...
            System.out.println(this.name + "'s ancestors are " + ancestors.toString());
            return ancestors;
	...
	private void addLine(String line) throws TreeException
	{
		...
		if (colonIndex < 0)
			throw new TreeException("Index less than 0");
		...
		else
		{
			...
			System.out.println("Parsed parentnode" + parentNode);
			if (parentNode == null) throw new TreeException("Parent Node not found");
		}
	...
	TreeNode getMostRecentCommonAncestor(String name1, String name2) throws TreeException
	{
		...
		if (node1 == null)
			throw new TreeException("No node1 found");
